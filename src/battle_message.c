...
static const u8 sText_Attack[] = _("Ataque Fís.");
static const u8 sText_Defense[] = _("Defesa Fís.");
static const u8 sText_Speed[] = _("Velocidade");
static const u8 sText_SpAttack[] = _("Ataque Esp.");
static const u8 sText_SpDefense[] = _("Defesa Esp.");
static const u8 sText_Accuracy[] = _("Precisão");
static const u8 sText_Evasiveness[] = _("Evasão");
